...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QIcon('sdu.ico'))
        ...
        self.original_img_v_lay_2 = QtWidgets.QVBoxLayout()
        self.original_img_v_lay_2.setObjectName("original_img_v_lay_2")
        spacerItem_2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.original_img_v_lay_2.addItem(spacerItem_2)
        self.original_name_lbl_2 = QtWidgets.QLabel(self.centralwidget)
        self.original_name_lbl_2.setScaledContents(False)
        self.original_name_lbl_2.setAlignment(QtCore.Qt.AlignCenter)
        self.original_name_lbl_2.setObjectName("original_name_lbl_2")
        self.original_img_v_lay_2.addWidget(self.original_name_lbl)
        spacerItem_21 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.original_img_v_lay_2.addItem(spacerItem_21)
        self.original_frame_lbl_2 = QtWidgets.QLabel(self.centralwidget)
        self.original_frame_lbl_2.setMinimumSize(QtCore.QSize(500, 500))
        self.original_frame_lbl_2.setAlignment(QtCore.Qt.AlignCenter)
        self.original_frame_lbl_2.setObjectName("original_frame_lbl_2")
        self.original_img_v_lay_2.addWidget(self.original_frame_lbl_2)
        self.selecamera3 = QtWidgets.QComboBox(self.centralwidget)
        self.selecamera3.setObjectName("selecamera3")
        self.original_img_v_lay_2.addWidget(self.selecamera3)
        spacerItem22 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.original_img_v_lay_2.addItem(spacerItem22)
        self.h_img_lay.addLayout(self.original_img_v_lay_2)
        ...
        self.idLabel.setText('患者ID：')
        self.h_btn_lay.addWidget(self.idLabel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "山东大学健康医疗大数据研究院———NIHDS"))
